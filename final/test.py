...
from alarm import play_sound  # assuming your alarm module is in the same directory as your main script
...
size['little'] = mf.trapmf(size.universe, [-1, 0, 92000, 112000])
size['medium'] = mf.trapmf(size.universe, [92000, 112000, 194000, 214000])
size['big'] = mf.trapmf(size.universe, [194000, 214000, 307199, 307200])
...
while cap.isOpened():
    ...
    print(distance.universe.shape, distance.universe.ndim)
    # print(distance['low'], distance['low'].ndim) 
    # print(distance_fuzz.shape, distance_fuzz.ndim)
    ...
    path = "final\Bahram-Ino-Befahm-(Ft-Erfan)-256.mp3"
    play_sound(path)
